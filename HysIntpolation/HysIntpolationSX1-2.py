...
data2 = np.loadtxt('/media/chenting/Work/Structural Engineering/Beam-CFSConnection/MTS Data/HysIntpolation/Beam-CFSSX1-2.txt')
...
for i in range(1, len(switch2)):
    ...
    for obj in ToBeInt:
        ...
        np.savetxt('/media/chenting/Work/Structural Engineering/Beam-CFSConnection/MTS Data/HysIntpolation/Beam-CFSSX1-2-Load.txt', Force)
