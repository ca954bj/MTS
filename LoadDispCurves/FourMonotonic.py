...
plt.plot(data1Uy1g, data1.Fy1, color='black', label='Right Beam', marker='^', markersize=10, markevery=(95, 85))
p1 = mlines.Line2D([], [], color='black', marker='^', markersize=10, label='Right Beam')

# Plot Left Beam Experimental Data
plt.plot(reverse1[5:], reverse2[5:], color='black', label='Left Beam', marker='v', markersize=10, markevery=(90, 85))
...
#plt.legend(handles=[p1, p2], loc=1, bbox_to_anchor=(0.99, 0.3), prop=fontprop)
...
plt.ylim(0, 180)
plt.xlim(0, 135)
plt.xticks([0, 30, 60, 90, 120, 140], fontproperties=fontprop)
...
#Uy2[0:-200]
plt.plot(reverse1[40:], reverse2[40:], color='black', label='Right Beam', marker='^', markersize=10, markevery=(100, 40))
p1 = mlines.Line2D([], [], color='black', marker='^', markersize=10, label='Right Beam')
plt.plot(data2uy2g[61:], data2.Fy2[61:], color='black', label='Left Beam', marker='v', markersize=10, markevery=(80, 40))
p2 = mlines.Line2D([], [], color='black', marker='v', markersize=10, label='Left Beam')
