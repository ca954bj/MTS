...
plt.plot(SX1data[:,0], SX1data[:,1]/2, color='k', linestyle='-', label='SX1', marker='^', markersize=10, markevery=52)
p1 = mlines.Line2D([], [], color='black', marker='^', markersize=10, label='SX1')
plt.plot(SY1data[:,0], SY1data[:,1]/2, color='k', linestyle='-', label='SY1', marker='v', markersize=10, markevery=59)
p2 = mlines.Line2D([], [], color='black', marker='v', markersize=10, label='SY1')
plt.plot(SX2data[:,0], SX2data[:,1]/2, color='k', linestyle='-', label='SX2', marker='*', markersize=10, markevery=20)
p3 = mlines.Line2D([], [], color='black', marker='*', markersize=10, label='SX2')
plt.plot(SY2data[:,0], SY2data[:,1]/2, color='k', linestyle='-', label='SY2', marker='o', markersize=10, markevery=59)
...
plt.xticks([-0.06, -0.04, -0.02, 0, 0.02, 0.04, 0.06], ['-6', '-4', '-2', '0', '2', '4', '6'], fontproperties=fontprop)
